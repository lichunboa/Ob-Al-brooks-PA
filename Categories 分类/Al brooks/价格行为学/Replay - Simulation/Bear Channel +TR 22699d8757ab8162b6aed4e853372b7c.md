...
Date: 2023年2月27日
Review Number: 4
Tags: Bear Trend, Globex Hour, TR
Trade Record: Yes
Winrate: 33
收获: 盘前trend的重要节点能帮助判断开始bar的走势。AOI依然有用！结合日线看图！
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Gap up后，B1 bear bar，结合盘前图像,抵达了盘前LEG1 = LEG2 MM | B1:big bear bar; B2: doji; B3: bear doji close low | 有点急切，好像是个不错的机会，可能应该等等突破了这个TR再说 | sell below  B3 | above B1 | TTR 中心位置 | 1.抵达盘前MM；2.big bear bar然后是两个长上影线，形成局部DT，可能去测试下方TTR | 1.盘前强势的bull trend，这里可能只是一个50 PB回调，而且盘前bull trend有一个gap，可以等待关了再看 | 感觉是个不错的trap setup，而且B1 break below TR.感觉会MM down | 被B5 stop loss | 确实应该按照想法**多等signal**，这里只是具备一个TR的雏形，没有真正向下的信号 | -8.5 |
| 2 | bear trend + TTR, big bear bar BO TTR 抵达均线下方。是TR BO也是L2 BEAR SETUP | B21，巨大的bear bar | TTR后，似乎应该发生点什么了 | sell below B21 | aboe B21 | 2R | 巨大的bear bar后，TTR整理，然后突破了TTR，EMA，是个TR BO也是BEAR L2 SETUP | TTR4次拒绝了下探要求，下方距离黄色AOI不愿，可能是 TR的second leg trap | B20假突破失败加大了这个 L2 sell setup的概率 | 止盈，但是profit很少，因为看到B26,36形成双底感觉不对。而且entry应该用rose 的trap setup，然后获取2R！ | 改进的可以**等**B22突破B21形成的trap，然后再B21的close附近entry，利用ROSE的trap setup | +1 |
| 3 | B53似乎形成LH MTR reversal | B53,B542个big bull bar | 急切，想赚取点什么 | B54 ABOVE | B54 BELOW | 2R | 这只是个TR上方！很多人等着sell！ | 强力bull bar，冲破EMA上方+ HL MTR可能 | 好久没trade了，遇到大bar想trade | 被B58stop loss | MTR的成功率是40%，这里依然是60%的TR/trend resume.一个好的做法是顺双势头。知道这里是bear trend→TR，最好是BLSH，而不是一时兴起追高！ | -6 |
| 4 | B58-B64一直是下降，抵达TR下沿，B65是个bull doji，似乎可以TR Buy Low | B65，差劲的signal | trade 3被TR打了止损，那么现在我学乖了，现在总该是TR了吧！ | buy above B65 | sell below B54 | 2R | B57是个50PB，而且B57至今都是下降没有什么PB，MTR的企图B53也被跌破了 | 现在处于TR底端 | 其实我应该听bear的 | 还好这里没有stop order启动，但是我记录这里是记录自己背上一个lose影响了自己的本次决策。 |  |  |

B1是bear bar，收的很好，有上影线代表强力卖压。结合下面globex图观看，可能会访问下方黄色区域。问题在于在线在ema附近。
...
- context是强力的bull micro channel，可能只是个PB
- 但是B12没有关闭B8 open，暂时没有影响那里buy the close的人
...
- trade 1, 2等待更多的signal比较好→ wait for one more bar，trade1还可以看盘前trend的gap！
