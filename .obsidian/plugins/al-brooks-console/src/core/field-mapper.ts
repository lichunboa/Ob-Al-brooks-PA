...
export const FIELD_ALIASES = {
  ...
  entryPrice: ["entry_price", "entryPrice", "入场/entry_price", "入场", "入场价格"],
  stopLoss: ["stop_loss", "stopLoss", "止损/stop_loss", "止损", "止损价格"],
  takeProfit: ["take_profit", "takeProfit", "目标位/take_profit", "目标位", "目标价格", "止盈"],
  initialRisk: ["initial_risk", "initialRisk", "初始风险/initial_risk", "初始风险", "风险"],
