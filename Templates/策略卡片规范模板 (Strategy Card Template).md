...
> 说明：frontmatter 只保留“会被消费”的字段，低频说明请写在正文，避免空值噪音。

> **字段说明**:
> - **方向/direction**: 必填,标识策略适用方向(做多/做空/双向)
> - **时间周期/timeframe**: 可选,标识策略最佳时间周期
> - **风险等级/risk_level**: 可选,标识策略风险水平(低/中/高)
> - 所有字段值必须来自`Templates/属性值预设.md`,严禁自创新值
