...
_DEFAULT_DB_PATH = os.path.join(_PROJECT_ROOT, "libs/database/services/telegram-service/signal_history.db")

def _get_db_path() -> str:
    """获取数据库路径（支持环境变量配置）"""
    return os.environ.get("SIGNAL_HISTORY_DB_PATH", _DEFAULT_DB_PATH)
