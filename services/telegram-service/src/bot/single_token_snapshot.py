...
TABLE_FIELDS: Dict[PanelType, Dict[str, Sequence[Tuple[str, str]]]] = {
    ...
    "futures": {
        # 仅专有字段；通用字段不重复
        "OI极值告警排行卡片": (("持仓Z分数", "Z分数"), ("持仓金额", "持仓金额"), ("持仓张数", "持仓张数")),
        "OI趋势排行卡片": (("持仓斜率", "持仓斜率"), ("持仓Z分数", "Z分数"), ("持仓金额", "持仓金额")),
        "OI连续性排行卡片": (("OI连续根数", "OI连续根数"),),
        "主动成交方向排行卡片": (("主动成交多空比", "主动多空比"), ("主动偏离", "主动偏离"), ("主动情绪动量", "主动动量")),
        "主动跳变排行卡片": (("主动跳变幅度", "主动跳变幅度"), ("主动成交多空比", "主动多空比")),
        "主动连续性排行卡片": (("主动连续根数", "主动连续根数"),),
        "全市场情绪排行卡片": (("全体多空比", "全体多空比"), ("全体偏离", "全体偏离"), ("全体波动", "全体波动")),
        "大户情绪排行卡片": (("大户多空比", "大户多空比"), ("大户偏离", "大户偏离"), ("大户情绪动量", "大户动量"), ("大户波动", "大户波动")),
        "情绪分歧排行卡片": (("情绪差值", "情绪差值"), ("情绪差值绝对值", "情绪绝对值")),
        "情绪动量排行卡片": (("大户情绪动量", "大户动量"), ("主动情绪动量", "全体动量")),
        "持仓增减速排行卡片": (("持仓变动%", "持仓变动%"), ("持仓变动", "持仓变动"), ("持仓金额", "持仓金额")),
        "持仓排行卡片": (("持仓金额", "持仓金额"), ("持仓张数", "持仓张数")),
        "新鲜度告警排行卡片": (("数据新鲜秒", "新鲜秒"), ("陈旧标记", "陈旧标记")),
        "期货持仓情绪排行卡片": (("大户多空比", "大户多空比"), ("全体多空比", "全体多空比"), ("持仓金额", "持仓金额"), ("持仓变动%", "持仓变动%")),
        "波动度排行卡片": (("波动率", "波动率"), ("大户波动", "大户波动"), ("全体波动", "全体波动"), ("稳定度分位", "稳定度分位")),
        "翻转雷达排行卡片": (("情绪翻转信号", "翻转信号"), ("大户多空比", "大户多空比")),
        "资金费率卡片": (("funding_rate", "资金费率"), ("weighted_rate", "加权费率")),
        "风险拥挤度排行卡片": (("风险分", "风险分"), ("市场占比", "市场占比"), ("持仓金额", "持仓金额")),
    },
    "advanced": {
        "EMA排行卡片": (
            ("EMA7", "EMA7"),
