...
- example 1: open reversal up→ spike + channel bull
    
    <aside>
    💡
    
    open reversal场景下【reversal一般发生在某些S&R】连续2个以上big bull bar close on high，还超过了bear leg的high[**均+颈+随**]，此时有70%可能先会产生MM.
    
    这时候可以
    
    - buy 50% PB of current bar
    - buy 5 point (smallest scalp) below current bar
    - buy at the market
    - buy the close
    </aside>
    
    ![image.png](49A%20Day%20trading%20examples/image.png)
    
    ![image.png](49A%20Day%20trading%20examples/image%201.png)
    
    ![image.png](49A%20Day%20trading%20examples/image%202.png)
    
- example 2: open reversal down → TR
    
    Brooks说B4,B5让他感觉open的时候出现这种连续big bear bar让他觉得是暂时AIS，即便他认为下面有50PB，这只是bear leg in TR。
    
    5个连续bear bar后，第一个PB，应该会有第二个bear leg。
    
    之后是WEDGE PB at 50PB ,注意MAG，这里就经常有final bull leg before MTR attempt.
    
    因为之前的bear channel tight，所以这里reversal up因该只是minor reversal。
    
    出现5个bull bar后，又reversal down了，因为这5个bull bar，接下来reversal down也应该只是minor reversal，所以出现了nested三角形!
    
    三角形后第一个BO，50%机率会fail and get reversal，这里抓住了second entry的机会，buy above bull bar + big H2 buy
    
    BULL BO L2 bear flag,所以期待MM。
    
    这个L2 也是合理的sell，但是考虑到前方的4 bull bar，降低了可能性。
...
- example 3: Parabolic Wedge Top → Bear Trend
    ...
    Parabolic Top的话，reversal一般会出现**5-10bar组成的tight bear channel**；如果是走了5-6bar然后sideway和bounce a bit，那么出现parabolic top + bear trend 的可能性就降低了
    
    </aside>
    
    ![image.png](49A%20Day%20trading%20examples/image%205.png)
    
    ![image.png](49A%20Day%20trading%20examples/image%206.png)
