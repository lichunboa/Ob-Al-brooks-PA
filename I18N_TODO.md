...
### 卡片字段标签
- [ ] `general_display_fields` / `special_display_fields` 中的字段标签
- [ ] 排序字段标签（如 "成交额", "振幅", "EMA7" 等）

### 信号模块
- [ ] `signals/formatter.py` - 信号格式化文本（138 行中文）
- [ ] `signals/engine_v2.py` - 日志消息（52 行中文）
