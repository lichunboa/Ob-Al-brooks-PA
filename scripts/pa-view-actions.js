...
<div style="background:rgba(34,197,94,0.05); padding:14px; border-radius:8px; border:1px solid rgba(34,197,94,0.2);">
  ...
  <div style="display:flex; flex-wrap:wrap; justify-content:center;">
    ${btn(c.live, "🟢 实盘交易 (Live)", "quickadd:choice:New Live Trade")}
    ${btn(c.demo, "🔵 模拟交易 (Demo)", "quickadd:choice:New Demo Trade")}
    ${btn(c.back, "🟡 回测记录 (Backtest)", "quickadd:choice:New Backtest")}
  </div>
</div>
`;
