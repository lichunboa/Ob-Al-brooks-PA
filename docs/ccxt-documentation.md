...
-   [**Exchanges**](https://docs.ccxt.com/#/?id=exchanges)
-   [**Markets**](https://docs.ccxt.com/#/?id=markets)
-   [**Implicit API**](https://docs.ccxt.com/#/?id=implicit-api)
-   [**Unified API**](https://docs.ccxt.com/#/?id=unified-api)
-   [**Public API**](https://docs.ccxt.com/#/?id=public-api)
-   [**Private API**](https://docs.ccxt.com/#/?id=private-api)
-   [**Error Handling**](https://docs.ccxt.com/#/?id=error-handling)
-   [**Troubleshooting**](https://docs.ccxt.com/#/?id=troubleshooting)
-   [**CCXT Pro**](https://docs.ccxt.com/#/?id=ccxt-pro)

## [Exchanges](https://docs.ccxt.com/#/?id=exchanges)

-   [Instantiation](https://docs.ccxt.com/#/?id=instantiation)
-   [Exchange Structure](https://docs.ccxt.com/#/?id=exchange-structure)
-   [Rate Limit](https://docs.ccxt.com/#/?id=rate-limit)The CCXT library currently supports the following 103 cryptocurrency exchange markets and trading APIs:

|logo|id|name|ver|type|certified|pro|
|---|---|---|---|---|---|---|
|[![alpaca](https://github.com/user-attachments/assets/e9476df8-a450-4c3e-ab9a-1a7794219e1b)](https://alpaca.markets/)|alpaca|
|[![apex](https://github.com/user-attachments/assets/fef8f2f7-4265-46aa-965e-33a91881cb00)](https://omni.apex.exchange/trade)|apex|
|[![arkham](https://github.com/user-attachments/assets/5cefdcfb-2c10-445b-835c-fa21317bf5ac)](https://arkm.com/register?ref=ccxt)|arkham|
|[![ascendex](https://github.com/user-attachments/assets/55bab6b9-d4ca-42a8-a0e6-fac81ae557f1)](https://ascendex.com/en-us/register?inviteCode=EL6BXBQM)|ascendex|
|[![backpack](https://github.com/user-attachments/assets/cc04c278-679f-4554-9f72-930dd632b80f)](https://backpack.exchange/join/ccxt)|backpack|
|[![bequant](https://github.com/user-attachments/assets/0583ef1f-29fe-4b7c-8189-63565a0e2867)](https://bequant.io/referral/dd104e3bee7634ec)|bequant|
|[![bigone](https://github.com/user-attachments/assets/4e5cfd53-98cc-4b90-92cd-0d7b512653d1)](https://b1.run/users/new?code=D3LLBVFT)|bigone|
|[![binance](https://github.com/user-attachments/assets/e9419b93-ccb0-46aa-9bff-c883f096274b)](https://accounts.binance.com/register?ref=CCXTCOM)|binance|
|[![binancecoinm](https://github.com/user-attachments/assets/387cfc4e-5f33-48cd-8f5c-cd4854dabf0c)](https://accounts.binance.com/register?ref=CCXTCOM)|binancecoinm|
|[![binanceus](https://github.com/user-attachments/assets/a9667919-b632-4d52-a832-df89f8a35e8c)](https://www.binance.us/?ref=35005074)|binanceus|
|[![binanceusdm](https://github.com/user-attachments/assets/871cbea7-eebb-4b28-b260-c1c91df0487a)](https://accounts.binance.com/register?ref=CCXTCOM)|binanceusdm|
|[![bingx](https://github-production-user-asset-6210df.s3.amazonaws.com/1294454/253675376-6983b72e-4999-4549-b177-33b374c195e3.jpg)](https://bingx.com/invite/OHETOM)|bingx|
|[![bit2c](https://github.com/user-attachments/assets/db0bce50-6842-4c09-a1d5-0c87d22118aa)](https://bit2c.co.il/Aff/63bfed10-e359-420c-ab5a-ad368dab0baf)|bit2c|
_this feature is currently a work in progress and might be incomplete, feel free to report any issues you find in it_
...
### [Overriding Exchange Properties Upon Instantiation](https://docs.ccxt.com/#/?id=overriding-exchange-properties-upon-instantiation)
...
### [Overriding Exchange Methods](https://docs.ccxt.com/#/?id=overriding-exchange-methods)
...
### [Testnets And Sandbox Environments](https://docs.ccxt.com/#/?id=testnets-and-sandbox-environments)
...
-   To obtain the [API keys](https://docs.ccxt.com/#/?id=authentication) to the sandbox the user has to register with the sandbox website of the exchange in question and create a sandbox keypair
...
### [Exchange Properties](https://docs.ccxt.com/#/?id=exchange-properties)
...
-   `enableRateLimit`: A boolean (true/false) value that enables the built-in rate limiter and throttles consecutive requests. This setting is `true` (enabled) by default. **The user is required to implement own [rate limiting](https://docs.ccxt.com/#/?id=rate-limit) or leave the built-in rate limiter enabled to avoid being banned from the exchange**.
...
-   `apiKey`: This is your public API key string literal. Most exchanges require [API keys setup](https://docs.ccxt.com/#/?id=api-keys-setup).
...
-   `precisionMode`: The exchange decimal precision counting mode, read more about [Precision And Limits](https://docs.ccxt.com/#/?id=precision-and-limits)
    
-   For proxies - `proxyUrl`, `httpUrl`, `httpsUrl`, `socksProxy`, `wsProxy`, `wssProxy`, `wsSocksProxy` : An url of specific proxy. Read details in [Proxy](https://docs.ccxt.com/#/?id=proxy) section.
    

See this section on [Overriding exchange properties](https://docs.ccxt.com/#/?id=overriding-exchange-properties-upon-instantiation).

#### [Exchange Metadata](https://docs.ccxt.com/#/?id=exchange-metadata)
...
## [Rate Limit](https://docs.ccxt.com/#/?id=rate-limit)

Exchanges usually impose what is called a _rate limit_. Exchanges will remember and track your user credentials and your IP address and will not allow you to query the API too frequently. They balance their load and control traffic congestion to protect API servers from (D)DoS and misuse.
...
### [Notes On Rate Limiter](https://docs.ccxt.com/#/?id=notes-on-rate-limiter)

#### [One Rate Limiter Per Each Exchange Instance](https://docs.ccxt.com/#/?id=one-rate-limiter-per-each-exchange-instance)
...
### [DDoS Protection By Cloudflare / Incapsula](https://docs.ccxt.com/#/?id=ddos-protection-by-cloudflare-incapsula)
...
-   use a [proxy](https://docs.ccxt.com/#/?id=proxy) (this is less responsive, though)
...
## [Maximum Requests capacity](https://docs.ccxt.com/#/?id=maximum-requests-capacity)
...
-   [Currency Structure](https://docs.ccxt.com/#/?id=currency-structure)
-   [Market Structure](https://docs.ccxt.com/#/?id=market-structure)
-   [Precision And Limits](https://docs.ccxt.com/#/?id=precision-and-limits)
-   [Loading Markets](https://docs.ccxt.com/#/?id=loading-markets)
-   [Symbols And Market Ids](https://docs.ccxt.com/#/?id=symbols-and-market-ids)
-   [Market Cache Force Reload](https://docs.ccxt.com/#/?id=market-cache-force-reload)
...
-   `active`. A boolean indicating whether trading or funding (depositing or withdrawing) for this currency is currently possible, more about it here: [`active` status](https://docs.ccxt.com/#/?id=active-status).
-   `info`. An associative array of non-common market properties, including fees, rates, limits and other general market information. The internal info array is different for each particular market, its contents depend on the exchange.
-   `precision`. Precision accepted in values by exchanges upon referencing this currency. The value of this property depends on [`exchange.precisionMode`](https://docs.ccxt.com/#/?id=precision-mode).
-   `limits`. The minimums and maximums for amounts (volumes), withdrawals and deposits.

## [Network Structure](https://docs.ccxt.com/#/?id=network-structure)
...
-   `active`. A boolean indicating whether or not trading this market is currently possible, more about it here: [`active` status](https://docs.ccxt.com/#/?id=active-status).
-   `maker`. Float, 0.0015 = 0.15%. Maker fees are paid when you provide liquidity to the exchange i.e. you _market-make_ an order and someone else fills it. Maker fees are usually lower than taker fees. Fees can be negative, this is very common amongst derivative exchanges. A negative fee means the exchange will pay a rebate (reward) to the user for trading this market (note, 'taker' and 'maker' publicly available fees, not taking into consideration your vip-level/volume/etc. Use [`fetchTradingFees`](https://docs.ccxt.com/#/?id=fee-schedule) to get the fees specific to your account).
-   `taker`. Float, 0.002 = 0.2%. Taker fees are paid when you _take_ liquidity from the exchange and fill someone else's order.
...
-   `info`. An associative array of non-common market properties, including fees, rates, limits and other general market information. The internal info array is different for each particular market, its contents depend on the exchange.
-   `precision`. Precision accepted in order values by exchanges upon order placement for price, amount and cost. (The value inside this property depend on the [`exchange.precisionMode`](https://docs.ccxt.com/#/?id=precision-mode)).
...
## [Active Status](https://docs.ccxt.com/#/?id=active-status)

The `active` flag is typically used in [`currencies`](https://docs.ccxt.com/#/?id=currency-structure) and [`markets`](https://docs.ccxt.com/#/?id=market-structure). The exchanges might put a slightly different meaning into it. If a currency is inactive, most of the time all corresponding tickers, orderbooks and other related endpoints return empty responses, all zeroes, no data or outdated information. The user should check if the currency is `active` and [reload markets periodically](https://docs.ccxt.com/#/?id=market-cache-force-reload).
...
-   _Precision of the amount_ should be up to 4 digits after dot (0.0001):
...
-   _Precision of the price_ should be up to 2 digits after dot (0.01):
...
2.  `(market['precision']['amount'] == -1)`
    ...
    A negative _precision_ might only theoretically happen if exchange's `precisionMode` is `SIGNIFICANT_DIGIT` or `DECIMAL_PRECISION`. It means that the amount should be an integer multiple of 10 (to the absolute power specified):
...
#### [Precision Mode](https://docs.ccxt.com/#/?id=precision-mode)
...
### [Notes On Precision And Limits](https://docs.ccxt.com/#/?id=notes-on-precision-and-limits)
...
### [Methods For Formatting Decimals](https://docs.ccxt.com/#/?id=methods-for-formatting-decimals)
...
#### [Padding Mode](https://docs.ccxt.com/#/?id=padding-mode)
...
**Make sure to [load the markets with `exchange.loadMarkets()`](https://docs.ccxt.com/#/?id=loading-markets) before calling these methods!**
...
### [Sharing Markets Between Exchange Instances](https://docs.ccxt.com/#/?id=sharing-markets-between-exchange-instances)
...
### [Methods For Markets And Currencies](https://docs.ccxt.com/#/?id=methods-for-markets-and-currencies)
...
### [Naming Consistency](https://docs.ccxt.com/#/?id=naming-consistency)
...
#### [Notes On Naming Consistency](https://docs.ccxt.com/#/?id=notes-on-naming-consistency)
...
#### [Questions On Naming Consistency](https://docs.ccxt.com/#/?id=questions-on-naming-consistency)
...
If it so happens that a symbol of a major token is forked or has to be changed, then the control is still in the users' hands. The `exchange.commonCurrencies` property can be [overrided upon initialization or later](https://docs.ccxt.com/#/?id=overriding-exchange-properties-upon-instantiation), just like any other exchange property. If a significant token is involved, we usually post instructions on how to retain the old behavior by adding a couple of lines to the constructor params.

#### [Consistency Of Base And Quote Currencies](https://docs.ccxt.com/#/?id=consistency-of-base-and-quote-currencies)
...
#### [Contract Naming Conventions](https://docs.ccxt.com/#/?id=contract-naming-conventions)
...
##### [Future](https://docs.ccxt.com/#/?id=future)
...
##### [Perpetual Swap (Perpetual Future)](https://docs.ccxt.com/#/?id=perpetual-swap-perpetual-future)
...
##### [Option](https://docs.ccxt.com/#/?id=option)
...
### [Unified Networks](https://docs.ccxt.com/#/?id=unified-networks)
...
-   [API Methods / Endpoints](https://docs.ccxt.com/#/?id=api-methods--endpoints)
-   [Implicit API Methods](https://docs.ccxt.com/#/?id=implicit-api-methods)
-   [Public/Private API](https://docs.ccxt.com/#/?id=publicprivate-api)
-   [Synchronous vs Asynchronous Calls](https://docs.ccxt.com/#/?id=synchronous-vs-asynchronous-calls)
-   [Passing Parameters To API Methods](https://docs.ccxt.com/#/?id=passing-parameters-to-api-methods)
...
### [Returned JSON Objects](https://docs.ccxt.com/#/?id=returned-json-objects)
...
For a full list of accepted method parameters for each exchange, please consult [API docs](https://docs.ccxt.com/#/?id=exchanges).

### [API Method Naming Conventions](https://docs.ccxt.com/#/?id=api-method-naming-conventions)
...
-   [Overriding Unified API Params](https://docs.ccxt.com/#/?id=overriding-unified-api-params)
-   [Pagination](https://docs.ccxt.com/#/?id=pagination)
-   [Automatic Pagination](https://docs.ccxt.com/#/?id=automatic-pagination)
...
_Warning: this is an experimental feature and might produce unexpected/incorrect results in some instances._

Recently, CCXT introduced a way to paginate through several results automatically by just providing the `paginate` flag inside `params,` lifting this work from the userland. Most leading exchanges support it, and more will be added in the future, but the easiest way to check it is to look in the method's documentation and search for the _pagination_ parameter. As always there are exceptions, and some endpoints might not provide a way to paginate either through a timestamp or a cursor, and in those cases, there's nothing CCXT can do about it.
...
_All the options below, should be provided inside `params`, you can check the examples below_

-   **paginate**: (**boolean**) indicates that the user wants to paginate through different pages to get more data. Default is _false_.
...
-   **paginationDirection**: (**string**) Only applies to the dynamic pagination and it can be either _forward_ (start the pagination from some time in the past and paginate forward) or _backward_ (start from the most recent time and paginate backward). If _forward_ is selected then a _since_ parameter must also be provided. Default is _backward_.
...
#### [Examples](https://docs.ccxt.com/#/?id=examples)
...
### [Working With Datetimes And Timestamps](https://docs.ccxt.com/#/?id=working-with-datetimes-and-timestamps)
...
See an example implementation here: [https://github.com/ccxt/ccxt/blob/master/examples/py/coinbasepro-fetch-my-trades-pagination.py](https://github.com/ccxt/ccxt/blob/master/examples/py/coinbasepro-fetch-my-trades-pagination.py)
...
-   [Order Book](https://docs.ccxt.com/#/?id=order-book)
-   [Price Tickers](https://docs.ccxt.com/#/?id=price-tickers)
-   [OHLCV Candlestick Charts](https://docs.ccxt.com/#/?id=ohlcv-candlestick-charts)
-   [Public Trades](https://docs.ccxt.com/#/?id=public-trades)
-   [Exchange Time](https://docs.ccxt.com/#/?id=exchange-time)
-   [Exchange Status](https://docs.ccxt.com/#/?id=exchange-status)
-   [Borrow Rates](https://docs.ccxt.com/#/?id=borrow-rates)
-   [Borrow Rate History](https://docs.ccxt.com/#/?id=borrow-rate-history)
-   [Leverage Tiers](https://docs.ccxt.com/#/?id=leverage-tiers)
-   [Funding Rate](https://docs.ccxt.com/#/?id=funding-rate)
-   [Funding Rate History](https://docs.ccxt.com/#/?id=funding-rate-history)
-   [Open Interest History](https://docs.ccxt.com/#/?id=open-interest-history)
-   [Volatility History](https://docs.ccxt.com/#/?id=volatility-history)
-   [Underlying Assets](https://docs.ccxt.com/#/?id=underlying-assets)
-   [Liquidations](https://docs.ccxt.com/#/?id=liquidations)
-   [Greeks](https://docs.ccxt.com/#/?id=greeks)
-   [OptionChain](https://docs.ccxt.com/#/?id=option-chain)

## [Order Book](https://docs.ccxt.com/#/?id=order-book)

Exchanges expose information on open orders with bid (buy) and ask (sell) prices, volumes and other data. Usually there is a separate endpoint for querying current state (stack frame) of the _order book_ for a particular market. An order book is also often called _market depth_. The order book information is used in the trading decision making process.
...
-   **symbol** (String) _required_ Unified CCXT symbol (e.g. `"BTC/USDT"`)
...
### [fetchOrderBook Examples](https://docs.ccxt.com/#/?id=fetchorderbook-examples)
...
### [Order Book Structure](https://docs.ccxt.com/#/?id=order-book-structure)
...
### [Notes On Order Book Structure](https://docs.ccxt.com/#/?id=notes-on-order-book-structure)
...
### [Market Depth](https://docs.ccxt.com/#/?id=market-depth)

Some exchanges accept a dictionary of extra parameters to the `fetchOrderBook () / fetch_order_book ()` function. **All extra `params` are exchange-specific (non-unified)**. You will need to consult exchanges docs if you want to override a particular param, like the depth of the order book. You can get a limited count of returned orders or a desired level of aggregation (aka _market depth_) by specifying an limit argument and exchange-specific extra `params` like so:
...
### [Market Price](https://docs.ccxt.com/#/?id=market-price)
...
### [A Single Ticker For One Symbol](https://docs.ccxt.com/#/?id=a-single-ticker-for-one-symbol)
...
### [Multiple Tickers For All Or Many Symbols](https://docs.ccxt.com/#/?id=multiple-tickers-for-all-or-many-symbols)
...
### [Ticker Structure](https://docs.ccxt.com/#/?id=ticker-structure)
...
#### [Notes On Ticker Structure](https://docs.ccxt.com/#/?id=notes-on-ticker-structure)
...
To get historical prices and volumes use the unified [`fetchOHLCV`](https://docs.ccxt.com/#/?id=ohlcv-candlestick-charts) method where available. To get historical mark, index, and premium index prices, add one of `'price': 'mark'`, `'price': 'index'`, `'price': 'premiumIndex'` respectively to the [params-overrides](https://docs.ccxt.com/#/?id=overriding-unified-api-params) of `fetchOHLCV`. There are also convenience methods `fetchMarkPriceOHLCV`, `fetchIndexPriceOHLCV`, and `fetchPremiumIndexOHLCV` that obtain the mark, index and premiumIndex historical prices and volumes.
...
### [Individually By Symbol](https://docs.ccxt.com/#/?id=individually-by-symbol)
...
### [All At Once](https://docs.ccxt.com/#/?id=all-at-once)

Some exchanges (not all of them) also support fetching all tickers at once. See [their docs](https://docs.ccxt.com/#/?id=exchanges) for details. You can fetch all tickers with a single call like so:
...
### [Get raw OHLCV response](https://docs.ccxt.com/#/?id=get-raw-ohlcv-response)
...
### [Notes On Latency](https://docs.ccxt.com/#/?id=notes-on-latency)
...
### [Build OHLCV bars from trades](https://docs.ccxt.com/#/?id=build-ohlcv-bars-from-trades)

As noted in above paragraph, users can build candles manually using `buildOHLCV / build_ohlcv` method. You can see an example file named "build-ohlcv-bars" inside [examples folder](https://github.com/ccxt/ccxt/tree/master/examples). Notes:
...
### [OHLCV Structure](https://docs.ccxt.com/#/?id=ohlcv-structure)
...
### [Mark, Index and PremiumIndex Candlestick Charts](https://docs.ccxt.com/#/?id=mark-index-and-premiumindex-candlestick-charts)

To obtain historical Mark, Index Price and Premium Index candlesticks pass the `'price'` [params-override](https://docs.ccxt.com/#/overriding-unified-api-params) to `fetchOHLCV`. The `'price'` parameter accepts one of the following values:
...
The fetchTrades method shown above returns an ordered list of trades (a flat array, sorted by timestamp in ascending order, oldest trade first, most recent trade last). A list of trades is represented by the [trade structure](https://docs.ccxt.com/#/?id=trade-structure).
...
To fetch historical trades, the user will need to traverse the data in portions or "pages" of objects. Pagination often implies _"fetching portions of data one by one"_ in a loop.
...
### [Exchange Status Structure](https://docs.ccxt.com/#/?id=exchange-status-structure)
...
-   A dictionary of [borrow rate structures](https://docs.ccxt.com/#/?id=borrow-rate-structure) with unified currency codes as keys
...
-   A dictionary of [isolated borrow rate structures](https://docs.ccxt.com/#/?id=isolated-borrow-rate-structure) with unified market symbols as keys

### [Isolated Borrow Rate Structure](https://docs.ccxt.com/#/?id=isolated-borrow-rate-structure)
...
### [Borrow Rate Structure](https://docs.ccxt.com/#/?id=borrow-rate-structure)
...
-   **code** (String) _required_ Unified CCXT currency code (e.g. `"USDT"`)
-   **since** (Integer) Timestamp for the earliest borrow rate (e.g. `1645807945000`)
-   **limit** (Integer) The maximum number of [borrow rate structures](https://docs.ccxt.com/#/?id=borrow-rate-structure) to retrieve (e.g. `10`)
-   **params** (Dictionary) Extra parameters specific to the exchange API endpoint (e.g. `{"endTime": 1645807945000}`)
...
-   **symbol** (String) _required_ Unified CCXT symbol (e.g. `"BTC/USDT:USDT"`)
-   **params** (Dictionary) Parameters specific to the exchange API endpoint (e.g. `{"settle": "usdt"}`)
...
-   an array of [leverage-tiers-structures](https://docs.ccxt.com/#/?id=leverage-tiers-structure)

### [Leverage Tiers Structure](https://docs.ccxt.com/#/?id=leverage-tiers-structure)
...
**Note for Huobi users:** Huobi uses both leverage and amount to determine maintenance margin rates: [https://www.huobi.com/support/en-us/detail/900000089903](https://www.huobi.com/support/en-us/detail/900000089903)
...
-   An array of [funding rate structures](https://docs.ccxt.com/#/?id=funding-rate-structure) indexed by market symbols

## [Funding Interval](https://docs.ccxt.com/#/?id=funding-interval)
...
### [Funding Rate Structure](https://docs.ccxt.com/#/?id=funding-rate-structure)
...
-   An array of [funding rate history structures](https://docs.ccxt.com/#/?id=funding-rate-history-structure)

### [Funding Rate History Structure](https://docs.ccxt.com/#/?id=funding-rate-history-structure)
...
## [Open Interest](https://docs.ccxt.com/#/?id=open-interest)
...
-   An [open interest structure](https://docs.ccxt.com/#/?id=open-interest-structure)
...
-   A dictionary of [open interest structures](https://docs.ccxt.com/#/?id=open-interest-structure)
...
-   **limit** (Integer) The maximum number of [open interest structures](https://docs.ccxt.com/#/?id=open-interest-structures) to retrieve (e.g. `10`)
-   **params** (Dictionary) Extra parameters specific to the exchange API endpoint (e.g. `{"endTime": 1645807945000}`)
...
-   An array of [open interest structures](https://docs.ccxt.com/#/?id=open-interest-structure)

### [Open Interest Structure](https://docs.ccxt.com/#/?id=open-interest-structure)
...
## [Historical Volatility](https://docs.ccxt.com/#/?id=historical-volatility)
...
-   **code** (String) _required_ Unified CCXT currency code (e.g. `"BTC"`)
-   **params** (Dictionary) Extra parameters specific to the exchange API endpoint (e.g. `{"endTime": 1645807945000}`)

Returns

-   An array of [volatility history structures](https://docs.ccxt.com/#/?id=volatility-structure)

### [Volatility Structure](https://docs.ccxt.com/#/?id=volatility-structure)
...
-   An [underlying assets structure](https://docs.ccxt.com/#/?id=underlying-assets-structure)

### [Underlying Assets Structure](https://docs.ccxt.com/#/?id=underlying-assets-structure)

```
[ 'BTC_USDT', 'ETH_USDT', 'DOGE_USDT' ]
```

## [Settlement History](https://docs.ccxt.com/#/?id=settlement-history)
...
-   An array of [settlement history structures](https://docs.ccxt.com/#/?id=settlement-history-structure)

### [Settlement History Structure](https://docs.ccxt.com/#/?id=settlement-history-structure)
...
### [Liquidation Structure](https://docs.ccxt.com/#/?id=liquidation-structure)
...
-   A list of [greeks structure](https://docs.ccxt.com/#/?id=greeks-structure)

### [Greeks Structure](https://docs.ccxt.com/#/?id=greeks-structure)
...
## [Option Chain](https://docs.ccxt.com/#/?id=option-chain)
...
### [Option Chain Structure](https://docs.ccxt.com/#/?id=option-chain-structure)
...
## [Long Short Ratio](https://docs.ccxt.com/#/?id=long-short-ratio)
...
-   a [long short ratio structure](https://docs.ccxt.com/#/?id=long-short-ratio-structure)
...
-   an array of [long short ratio structures](https://docs.ccxt.com/#/?id=long-short-ratio-structure)

### [Long Short Ratio Structure](https://docs.ccxt.com/#/?id=long-short-ratio-structure)
...
-   [Authentication](https://docs.ccxt.com/#/?id=authentication)
-   [Sign In](https://docs.ccxt.com/#/?id=sign-in)
-   [API Keys Setup](https://docs.ccxt.com/#/?id=api-keys-setup)
-   [Accounts](https://docs.ccxt.com/#/?id=accounts)
-   [Account Balance](https://docs.ccxt.com/#/?id=account-balance)
-   [Orders](https://docs.ccxt.com/#/?id=orders)
-   [My Trades](https://docs.ccxt.com/#/?id=my-trades)
-   [Ledger](https://docs.ccxt.com/#/?id=ledger)
-   [Deposit](https://docs.ccxt.com/#/?id=deposit)
-   [Withdrawal](https://docs.ccxt.com/#/?id=withdrawal)
-   [Deposit Addresses](https://docs.ccxt.com/#/?id=deposit-addresses)
-   [Transfers](https://docs.ccxt.com/#/?id=transfers)
-   [Fees](https://docs.ccxt.com/#/?id=fees)
-   [Borrow Interest](https://docs.ccxt.com/#/?id=borrow-interest)
-   [Borrow And Repay Margin](https://docs.ccxt.com/#/?id=borrow-and-repay-margin)
-   [Margin](https://docs.ccxt.com/#/?id=margin)
-   [Margin Mode](https://docs.ccxt.com/#/?id=margin-mode)
-   [Leverage](https://docs.ccxt.com/#/?id=leverage)
-   [Positions](https://docs.ccxt.com/#/?id=positions)
-   [Funding History](https://docs.ccxt.com/#/?id=funding-history)
-   [Conversion](https://docs.ccxt.com/#/?id=conversion)
...
-   the current state of the user's account balance can be obtained with the `fetchBalance()` method as described in the [Account Balance](https://docs.ccxt.com/#/?id=account-balance) section
-   the user can place and cancel orders with `createOrder()`, `cancelOrder()`, as well as fetch current open orders and the past order history with methods like `fetchOrder`, `fetchOrders()`, `fetchOpenOrder()`, `fetchOpenOrders()`, `fetchCanceledOrders`, `fetchClosedOrder`, `fetchClosedOrders`, as described in the section on [Orders](https://docs.ccxt.com/#/?id=orders)
-   the user can query the history of past trades executed with their account using `fetchMyTrades`, as described in the [My Trades](https://docs.ccxt.com/#/?id=my-trades) section, also see [How Orders Are Related To Trades](https://docs.ccxt.com/#/?id=how-orders-are-related-to-trades)
-   the user can query their positions with `fetchPositions()` and `fetchPosition()` as described in the [Positions](https://docs.ccxt.com/#/?id=positions) section
...
-   if the exchange API provides a ledger endpoint, the user can fetch a history of all money movements that somehow affected the balance, with `fetchLedger` that will return all accounting ledger entries such as trades, deposits, withdrawals, internal transfers between accounts, rebates, bonuses, fees, staking profits and so on, as described in the [Ledger](https://docs.ccxt.com/#/?id=ledger) section.
...
**DO NOT REUSE API KEYS WITH DIFFERENT SOFTWARE! The other software will screw your nonce too high. If you get [InvalidNonce](https://docs.ccxt.com/#/?id=invalid-nonce) errors – make sure to generate a fresh new keypair first and foremost.**
...
#### [Required Credentials](https://docs.ccxt.com/#/?id=required-credentials)

The API credentials usually include the following:

-   `apiKey`. This is your public API Key and/or Token. This part is _non-secret_, it is included in your request header or body and sent over HTTPS in open text to identify your request. It is often a string in Hex or Base64 encoding or an UUID identifier.
...
-   `uid`. Some exchanges (not all of them) also generate a user id or _uid_ for short. It can be a string or numeric literal. You should set it, if that is explicitly required by your exchange. See [their docs](https://docs.ccxt.com/#/?id=exchanges) for details.
-   `password`. Some exchanges (not all of them) also require your password/phrase for trading. You should set this string, if that is explicitly required by your exchange. See [their docs](https://docs.ccxt.com/#/?id=exchanges) for details.
...
#### [Credential Validation](https://docs.ccxt.com/#/?id=credential-validation)
...
#### [Configuring API Keys](https://docs.ccxt.com/#/?id=configuring-api-keys)
...
#### [API Key Permissions](https://docs.ccxt.com/#/?id=api-key-permissions)
...
#### [**Javascript**](https://docs.ccxt.com/#/?id=javascript)
...
## [Overriding The Nonce](https://docs.ccxt.com/#/?id=overriding-the-nonce)
...
### [Accounts Structure](https://docs.ccxt.com/#/?id=accounts-structure)
...
Types of account is one of the [unified account types](https://docs.ccxt.com/#/##Account-Balance) or `subaccount`
...
### [Balance Structure](https://docs.ccxt.com/#/?id=balance-structure)
...
### [Querying Orders](https://docs.ccxt.com/#/?id=querying-orders)
...
Note that the naming of those methods indicates if the method returns a single order or multiple orders (an array/list of orders). The `fetchOrder()` method requires a mandatory order id argument (a string). Some exchanges also require a symbol to fetch an order by id, where order ids can intersect with various trading pairs. Also, note that all other methods above return an array (a list) of orders. Most of them will require a symbol argument as well, however, some exchanges allow querying with a symbol unspecified (meaning _all symbols_).
...
#### [Understanding The Orders API Design](https://docs.ccxt.com/#/?id=understanding-the-orders-api-design)
...
#### [Querying Multiple Orders And Trades](https://docs.ccxt.com/#/?id=querying-multiple-orders-and-trades)
...
#### [By Order Id](https://docs.ccxt.com/#/?id=by-order-id)
...
#### [All Orders](https://docs.ccxt.com/#/?id=all-orders)
...
#### [Open Orders](https://docs.ccxt.com/#/?id=open-orders)
...
#### [Closed Orders](https://docs.ccxt.com/#/?id=closed-orders)

Do not confuse _closed orders_ with _trades_ aka _fills_ ! An order can be closed (filled) with multiple opposing trades! So, a _closed order_ is not the same as a _trade_. In general, the order does not have a `fee` at all, but each particular user trade does have `fee`, `cost` and other properties. However, many exchanges propagate those properties to the orders as well.
...
-   The `cost` of an order means the total _quote_ volume of the order (whereas the `amount` is the _base_ volume). The value of `cost` should be as close to the actual most recent known order cost as possible. The `cost` field itself is there mostly for convenience and can be deduced from other fields.
-   The `clientOrderId` field can be set upon placing orders by the user with [custom order params](https://docs.ccxt.com/#/?id=custom-order-params). Using the `clientOrderId` the user can later distinguish between own orders. This is only available for the exchanges that do support `clientOrderId` at this time.

#### [timeInForce](https://docs.ccxt.com/#/?id=timeinforce)
...
### [Placing Orders](https://docs.ccxt.com/#/?id=placing-orders)
...
-   [Limit Orders](https://docs.ccxt.com/#/?id=limit-orders) – regular orders having an `amount` in base currency (how much you want to buy or sell) and a `price` in quote currency (for which price you want to buy or sell).
-   [Market Orders](https://docs.ccxt.com/#/?id=market-orders) – regular orders having an `amount` in base currency (how much you want to buy or sell)
    -   [Market Buys](https://docs.ccxt.com/#/?id=market-buys) – some exchanges require market buy orders with an `amount` in quote currency (how much you want to spend for buying)
-   [Trigger Orders](https://docs.ccxt.com/#/?id=conditional-orders) aka _conditional orders_ – an advanced type of order used to wait for a certain condition on a market and then react automatically: when a `triggerPrice` is reached, the trigger order gets triggered and then a regular limit `price` or market price order is placed, that eventually results in entering a position or exiting a position
-   [Stop Loss Orders](https://docs.ccxt.com/#/?id=stop-loss-orders) – almost the same as trigger orders, but used to close a position to stop further losses on that position: when the price reaches `triggerPrice` then the stop loss order is triggered that results in placing another regular limit or market order to close a position at a specific limit `price` or at market price (a position with a stop loss order attached to it).
-   [Take Profit Orders](https://docs.ccxt.com/#/?id=take-profit-orders) – a counterpart to stop loss orders, this type of order is used to close a position to take existing profits on that position: when the price reaches `triggerPrice` then the take profit order is triggered that results in placing another regular limit or market order to close a position at a specific limit `price` or at market price (a position with a take profit order attached to it).
-   [StopLoss And TakeProfit Orders Attached To A Position](https://docs.ccxt.com/#/?id=stoploss-and-takeprofit-orders-attached-to-a-position) – advanced orders, consisting of three orders of types listed above: a regular limit or market order placed to enter a position with stop loss and/or take profit orders that will be placed upon opening that position and will be used to close that position later (when a stop loss is reached, it will close the position and will cancel its take profit counterpart, and vice versa, when a take profit is reached, it will close the position and will cancel its stop loss counterpart, these two counterparts are also known as "OCO orders – one cancels the other), apart from the `amount` (and `price` for the limit order) to open a position it will also require a `triggerPrice` for a stop loss order (with a limit `price` if it's a stop loss limit order) and/or a `triggerPrice` for a take profit order (with a limit `price` if it's a take profit limit order).
-   [Trailing Orders](https://docs.ccxt.com/#/?id=trailing-orders) – an order that is automatically adjusted relative to an open position, `trailingAmount` can be set to trail a specified quote amount behind the open position or `trailingPercent` can be set to trail a specified percent behind the open position, when the market price of the position is equal to the trailing order this results in entering a new position or exiting a position depending on if the trailing order has the `reduceOnly` parameter set to true or not.

Placing an order always requires a `symbol` that the user has to specify (which market you want to trade).

To place an order use the `createOrder` method. You can use the `id` from the returned unified [order structure](https://docs.ccxt.com/#/?id=order-structure) to query the status and the state of the order later. If you need to place multiple orders simultaneously, you can check the availability of the `createOrders` method.
...
-   **symbol** (String) _required_ Unified CCXT market symbol
    -   Make sure the symbol in question exists with the target exchange and is available for trading.
-   **side** _required_ a string literal for the direction of your order. **Unified sides:**
...
-   **type** a string literal type of order **Unified types:**
    -   [market](https://docs.ccxt.com/#/market-orders) not allowed by some exchanges, see [their docs](https://docs.ccxt.com/#/?id=exchanges) for details
    -   [limit](https://docs.ccxt.com/#/limit-orders)
...
-   A successful order call returns a [order structure](https://docs.ccxt.com/#/?id=order-structure)

**Notes on createOrder**

-   Some exchanges will allow to trade with limit orders only.

Some fields from the returned order structure may be `undefined / None / null` if that information is not returned from the exchange API's response. The user is guaranteed that the `createOrder` method will return a unified [order structure](https://docs.ccxt.com/#/?id=order-structure) that will contain at least the order `id` and the `info` (a raw response from the exchange "as is"):
...
##### [Common pitfalls](https://docs.ccxt.com/#/?id=common-pitfalls)
...
This error happens when the exchange is expecting a natural number of contracts (1,2,3, etc) in the `amount` argument of `createOrder`. The [market structure](https://docs.ccxt.com/#/?id=market-structure) has a key called `contractSize`. Each contract is worth a certain amount of the base asset that is determined by the `contractSize`. The number of contracts multiplied by the `contractSize` is equal to the base amount. `Base amount = (contracts * contractSize)` so to derive the number of contracts you should enter in the `amount` argument you can solve for contracts: `contracts = (Base amount / contractSize)`.
...
#### [Limit Orders](https://docs.ccxt.com/#/?id=limit-orders)

Limit orders placed on the order book of the exchange for a price specified by the trader. They are fullfilled(closed) when there are no orders in the same market at a better price, and another trader creates a [market order](https://docs.ccxt.com/#/market-orders) or an opposite order for a price that matches or exceeds the price of the limit order.
...
#### [Market Orders](https://docs.ccxt.com/#/?id=market-orders)
...
#### [Market Buys](https://docs.ccxt.com/#/?id=market-buys)
...
#### [Emulating Market Orders With Limit Orders](https://docs.ccxt.com/#/?id=emulating-market-orders-with-limit-orders)
...
#### [Limit Orders](https://docs.ccxt.com/#/?id=limit-orders-1)

Limit price orders are also known as _limit orders_. Some exchanges accept limit orders only. Limit orders require a price (rate per unit) to be submitted with the order. The exchange will close limit orders if and only if market price reaches the desired level.
...
#### [Conditional Orders](https://docs.ccxt.com/#/?id=conditional-orders)
...
1.  standalone [Trigger order](https://docs.ccxt.com/#/?id=trigger-order) to buy/sell coin (open/close position)
2.  standalone [Stop Loss](https://docs.ccxt.com/#/?id=stop-loss-orders) or [Take Profit](https://docs.ccxt.com/#/?id=take-profit-orders) designed to close open positions.
3.  a Stop Loss or Take Profit order attached to a primary order ([Conditional Trigger Order](https://docs.ccxt.com/#/?id=stoploss-and-takeprofit-orders-attached-to-a-position)).

##### [Trigger order](https://docs.ccxt.com/#/?id=trigger-order)
...
##### [Stop Loss Orders](https://docs.ccxt.com/#/?id=stop-loss-orders)
...
##### [Take Profit Orders](https://docs.ccxt.com/#/?id=take-profit-orders)
...
#### [StopLoss And TakeProfit Orders Attached To A Position](https://docs.ccxt.com/#/?id=stoploss-and-takeprofit-orders-attached-to-a-position)
...
#### [Trailing Orders](https://docs.ccxt.com/#/?id=trailing-orders)
...
_Not supported by all exchanges._

_Note: This is still under unification and is a work in progress_
...
#### [Custom Order Params](https://docs.ccxt.com/#/?id=custom-order-params)
...
##### [User-defined `clientOrderId`](https://docs.ccxt.com/#/?id=user-defined-clientorderid)
...
##### [Hedge mode for order](https://docs.ccxt.com/#/?id=hedge-mode-for-order)

If exchange supports [feature](https://docs.ccxt.com/#/?id=features) for `hedged` orders, user can pass `params['hedged'] = true` in `createOrder` to open a `hedged` position instead of default `one-way` mode order. However, if exchange supports `.has['setPositionMode']` then those exchanges might not support `hedged` param directly through `createOrder`, instead on such exchange you need to change the account-mode at first using [setPositionMode()](https://docs.ccxt.com/#/?id=set-position-mode) and then run `createOrder` (without `hedged` param) and it will place hedged order by default.

### [Editing Orders](https://docs.ccxt.com/#/?id=editing-orders)
...
-   **id** (String) _required_ Order id (e.g. `1645807945000`)
-   **symbol** (String) _required_ Unified CCXT market symbol
-   **side** (String) _required_ the direction of your order. **Unified sides:**
    -   `buy` give quote currency and receive base currency; for example, buying `BTC/USD` means that you will receive bitcoins for your dollars.
    -   `sell` give base currency and receive quote currency; for example, buying `BTC/USD` means that you will receive dollars for your bitcoins.
-   **type** (String) _required_ type of order **Unified types:**
    -   [`market`](https://docs.ccxt.com/#/market-orders) not allowed by some exchanges, see [their docs](https://docs.ccxt.com/#/?id=exchanges) for details
    -   [`limit`](https://docs.ccxt.com/#/limit-orders)
    -   see #custom-order-params and #other-order-types for non-unified types
-   **amount** (Number) _required_ how much of currency you want to trade usually, but not always, in units of the base currency of the trading pair symbol (the units for some exchanges are dependent on the side of the order: see their API docs for details.)
...
### [Canceling Orders](https://docs.ccxt.com/#/?id=canceling-orders)
...
-   **ids** (\[String\]) _required_ Order ids (e.g. `1645807945000`)
-   **symbol** (String) Unified CCXT market symbol **required** on some exchanges (e.g. `"BTC/USDT"`)
-   **params** (Dictionary) Extra parameters specific to the exchange API endpoint (e.g. `{"settle": "usdt"}`)

Returns

-   An array of [order structures](https://docs.ccxt.com/#/?id=order-structure)
...
#### [Exceptions Upon Canceling Orders](https://docs.ccxt.com/#/?id=exceptions-upon-canceling-orders)
...
To put it shortly, an order can contain _one or more_ trades. Or, in other words, an order can be _filled_ with one or more trades.
...
1.  Order `b` is matched against the incoming sell because their prices intersect. Their volumes _"mutually annihilate"_ each other, so, the bidder gets 100 for a price of 0.800. The seller (asker) will have their sell order partially filled by bid volume 100 for a price of 0.800. Note that for the filled part of the order the seller gets a better price than he asked for initially. He asked for 0.7 at least but got 0.8 instead which is even better for the seller. Most conventional exchanges fill orders for the best price available.
    
2.  A trade is generated for the order `b` against the incoming sell order. That trade _"fills"_ the entire order `b` and most of the sell order. One trade is generated per each pair of matched orders, whether the amount was filled completely or partially. In this example the seller amount (100) fills order `b` completely (closes the order `b`) and also fills the selling order partially (leaves it open in the orderbook).
...
### [Personal Trades](https://docs.ccxt.com/#/?id=personal-trades)

Most of unified methods will return either a single object or a plain array (a list) of objects (trades). However, very few exchanges (if any at all) will return all trades at once. Most often their APIs `limit` output to a certain number of most recent objects. **YOU CANNOT GET ALL OBJECTS SINCE THE BEGINNING OF TIME TO THE PRESENT MOMENT IN JUST ONE CALL**. Practically, very few exchanges will tolerate or allow that.

As with all other unified methods for fetching historical data, the `fetchMyTrades` method accepts a `since` argument for [date-based pagination](https://docs.ccxt.com/#/?id=date-based-pagination). Just like with all other unified methods throughout the CCXT library, the `since` argument for `fetchMyTrades` must be an **integer timestamp in milliseconds**.
...
In most cases users are **required to use at least some type of [pagination](https://docs.ccxt.com/#/?id=pagination)** in order to get the expected results consistently.
...
#### [Trade Structure](https://docs.ccxt.com/#/?id=trade-structure)

Trades denote the exchange of one currency for another, unlike [transactions](https://docs.ccxt.com/#/?id=transaction-structure), which denote a transfer of a given coin.
...
-   The `fee` currency may be different from both traded currencies (for example, an ETH/BTC order with fees in USD).
-   The `cost` of the trade means `amount * price`. It is the total _quote_ volume of the trade (whereas `amount` is the _base_ volume). The cost field itself is there mostly for convenience and can be deduced from other fields.
-   The `cost` of the trade is a _"gross"_ value. That is the value pre-fee, and the fee has to be applied afterwards.

### [Trades By Order Id](https://docs.ccxt.com/#/?id=trades-by-order-id)
...
-   **id** (String) _required_ Ledger entry id
-   **code** (String) Unified CCXT currency code, required (e.g. `"USDT"`)
-   **params** (Dictionary) Parameters specific to the exchange API endpoint (e.g. `{"type": "deposit"}`)

Returns

-   A [ledger entry structure](https://docs.ccxt.com/#/?id=ledger-entry-structure)
...
-   **code** (String) Unified CCXT currency code; _required_ if fetching all ledger entries for all assets at once is not supported (e.g. `"USDT"`)
-   **since** (Integer) Timestamp (ms) of the earliest time to retrieve withdrawals for (e.g. `1646940314000`)
-   **limit** (Integer) The number of [ledger entry structures](https://docs.ccxt.com/#/?id=ledger-entry-structure) to retrieve (e.g. `5`)
-   **params** (Dictionary) Parameters specific to the exchange API endpoint (e.g. `{"endTime": 1645807945000}`)

Returns

-   An array of [ledger entry structures](https://docs.ccxt.com/#/?id=ledger-entry-structure)

### [Ledger Entry Structure](https://docs.ccxt.com/#/?id=ledger-entry-structure)
...
#### [Notes On Ledger Entry Structure](https://docs.ccxt.com/#/?id=notes-on-ledger-entry-structure)
...
To deposit fiat currency on an exchange you can use the `deposit` method with data retrieved from the `fetchDepositMethodId` method. _this deposit feature is currently supported on coinbase only, feel free to report any issues you find_
...
-   **id** (String) _required_ Deposit id
...
-   A [deposit id structure](https://docs.ccxt.com/#/?id=deposit-id-structure)
...
-   An array of [deposit id structures](https://docs.ccxt.com/#/?id=deposit-id-structure)

### [Deposit Id Structure](https://docs.ccxt.com/#/?id=deposit-id-structure)
...
-   **limit** (Integer) The number of [transaction structures](https://docs.ccxt.com/#/?id=transaction-structure) to retrieve (e.g. `5`)
-   **params** (Dictionary) Parameters specific to the exchange API endpoint (e.g. `{"endTime": 1645807945000}`)

Returns

-   An array of [transaction structures](https://docs.ccxt.com/#/?id=transaction-structure)
...
In some cases you can also use the withdrawal id to check withdrawal status later (whether it succeeded or not) and to submit 2FA confirmation codes, where this is supported by the exchange. See [their docs](https://docs.ccxt.com/#/?id=exchanges) for details.
...
-   **code** (String) _required_ Unified CCXT currency code (e.g. `"USDT"`)
-   **amount** (Float) _required_ The amount of currency to withdraw (e.g. `20`)
-   **address** (String) _required_ The recipient address of the withdrawal (e.g. `"TEY6qjnKDyyq5jDc3DJizWLCdUySrpQ4yp"`)
...
-   **id** (String) _required_ Withdrawal id
-   **code** (String) Unified CCXT currency code (e.g. `"USDT"`)
-   **params** (Dictionary) Parameters specific to the exchange API endpoint (e.g. `{"network": "TRX"}`)
...
### [Deposit And Withdrawal Networks](https://docs.ccxt.com/#/?id=deposit-and-withdrawal-networks)
...
### [Transaction Structure](https://docs.ccxt.com/#/?id=transaction-structure)

Transactions denote a transfer of a given coin, unlike [trades](https://docs.ccxt.com/#/?id=trade-structure), which denote the exchange of one currency for another.

-   _deposit structure_
-   _withdrawal structure_
...
#### [Notes On Transaction Structure](https://docs.ccxt.com/#/?id=notes-on-transaction-structure)
...
### [fetchDeposits Examples](https://docs.ccxt.com/#/?id=fetchdeposits-examples)
...
### [fetchWithdrawals Examples](https://docs.ccxt.com/#/?id=fetchwithdrawals-examples)
...
### [fetchTransactions Examples](https://docs.ccxt.com/#/?id=fetchtransactions-examples)
...
-   an array of [address structures](https://docs.ccxt.com/#/?id=address-structure)
...
### [Address Structure](https://docs.ccxt.com/#/?id=address-structure)
...
### [Account Types](https://docs.ccxt.com/#/?id=account-types)

`fromAccount` and `toAccount` can accept the exchange account id or one of the following unified values:

-   `funding` _for some exchanges `funding` and `spot` are the same account_
-   `main` _for some exchanges that allow for subaccounts_
-   `spot`
-   `margin`
-   `future`
-   `swap`
...
-   **limit** (Integer) The number of [transfer structures](https://docs.ccxt.com/#/?id=transfer-structure) to retrieve (e.g. `5`)
-   **params** (Dictionary) Parameters specific to the exchange API endpoint (e.g. `{"endTime": 1645807945000}`)

Returns

-   An array of [transfer structures](https://docs.ccxt.com/#/?id=transfer-structure)
...
### [Transfer Structure](https://docs.ccxt.com/#/?id=transfer-structure)
...
### [Fee Structure](https://docs.ccxt.com/#/?id=fee-structure)
...
### [Fee Schedule](https://docs.ccxt.com/#/?id=fee-schedule)
...
### [Trading Fees](https://docs.ccxt.com/#/?id=trading-fees)
...
Accessing trading fee rates should be done via [`fetchTradingFees`](https://docs.ccxt.com/#/?id=fee-schedule) which is the recommended approach. If that method is not supported by exchange, then via the `.markets` property, like so:
...
Maker fees are paid when you provide liquidity to the exchange i.e. you _market-make_ an order and someone else fills it. Maker fees are usually lower than taker fees. Similarly, taker fees are paid when you _take_ liquidity from the exchange and fill someone else's order.
...
#### [Trading Fee Schedule](https://docs.ccxt.com/#/?id=trading-fee-schedule)
...
-   **symbol** (String) _required_ Unified market symbol (e.g. `"BTC/USDT"`)
-   **params** (Dictionary) Parameters specific to the exchange API endpoint (e.g. `{"currency": "quote"}`)

Returns

-   A [trading fee structure](https://docs.ccxt.com/#/?id=trading-fee-structure)
...
-   An array of [trading fee structures](https://docs.ccxt.com/#/?id=trading-fee-structure)

#### [Trading Fee Structure](https://docs.ccxt.com/#/?id=trading-fee-structure)
...
### [Transaction Fees](https://docs.ccxt.com/#/?id=transaction-fees)
...
#### [Transaction Fee Schedule](https://docs.ccxt.com/#/?id=transaction-fee-schedule)
...
-   **code** (String) _required_ Unified CCXT currency code, required (e.g. `"USDT"`)
-   **params** (Dictionary) Parameters specific to the exchange API endpoint (e.g. `{"type": "deposit"}`)
-   **params.network** (String) Specify unified CCXT network (e.g. `{"network": "TRC20"}`)

Returns

-   A [transaction fee structure](https://docs.ccxt.com/#/?id=transaction-fee-structure)
...
-   An array of [transaction fee structures](https://docs.ccxt.com/#/?id=transaction-fee-structure)

#### [Transaction Fee Structure](https://docs.ccxt.com/#/?id=transaction-fee-structure)
...
-   **limit** (Integer) The number of [borrow interest structures](https://docs.ccxt.com/#/?id=borrow-interest-structure) to retrieve (e.g. `5`)
-   **params** (Dictionary) Parameters specific to the exchange API endpoint (e.g. `{"endTime": 1645807945000}`)

Returns

-   An array of [borrow interest structures](https://docs.ccxt.com/#/?id=borrow-interest-structure)

### [Borrow Interest Structure](https://docs.ccxt.com/#/?id=borrow-interest-structure)
...
-   **code** (String) _required_ The unified currency code for the currency to be borrowed or repaid (e.g. `"USDT"`)
-   **amount** (Float) _required_ The amount of margin to borrow or repay (e.g. `20.92`)
...
-   **symbol** (String) _required_ The unified CCXT market symbol of an isolated margin market (e.g. `"BTC/USDT"`)
-   **code** (String) _required_ The unified currency code for the currency to be borrowed or repaid (e.g. `"USDT"`)
-   **amount** (Float) _required_ The amount of margin to borrow or repay (e.g. `20.92`)
-   **params** (Dictionary) Parameters specific to the exchange API endpoint (e.g. `{"rate": 0.002}`)
...
### [Margin Loan Structure](https://docs.ccxt.com/#/?id=margin-loan-structure)
...
-   **symbol** (String) _required_ Unified CCXT market symbol (e.g. `"BTC/USDT:USDT"`)
-   **amount** (String) _required_ Amount of margin to add or reduce (e.g. `20`)
-   **params** (Dictionary) Parameters specific to the exchange API endpoint (e.g. `{"leverage": 5}`)

Returns

-   a [margin structure](https://docs.ccxt.com/#/?id=margin-structure)
...
-   **limit** (Integer) The number of [margin structures](https://docs.ccxt.com/#/?id=margin-structure) to retrieve (e.g. `5`)
...
### [Margin Structure](https://docs.ccxt.com/#/?id=margin-structure)
...
## [Set Margin Mode](https://docs.ccxt.com/#/?id=set-margin-mode)
...
-   **marginMode** (String) _required_ the type of margin used **Unified margin types:**
    -   `"cross"`
    -   `"isolated"`
-   **symbol** (String) Unified CCXT market symbol (e.g. `"BTC/USDT:USDT"`) _required_ on most exchanges. Is not required when the margin mode is not specific to a market
-   **params** (Dictionary) Parameters specific to the exchange API endpoint (e.g. `{"leverage": 5}`)
...
### [Exchanges Without setMarginMode](https://docs.ccxt.com/#/?id=exchanges-without-setmarginmode)
...
### [Notes On Suppressed Errors For setMarginMode](https://docs.ccxt.com/#/?id=notes-on-suppressed-errors-for-setmarginmode)
...
### [Notes On The marginMode Parameter](https://docs.ccxt.com/#/?id=notes-on-the-marginmode-parameter)
...
_Use a unified spot symbol, while setting the marginMode parameter._
...
## [Fetch Margin Mode](https://docs.ccxt.com/#/?id=fetch-margin-mode)
...
-   **symbol** (String) _required_ A unified CCXT symbol (e.g. `"BTC/USDT:USDT"`)
...
-   an array of [margin-mode-structures](https://docs.ccxt.com/#/?id=margin-mode-structure)

### [Margin Mode Structure](https://docs.ccxt.com/#/?id=margin-mode-structure)
...
## [Set Leverage](https://docs.ccxt.com/#/?id=set-leverage)
...
-   **leverage** (Integer) _required_ The desired leverage
-   **symbol** (String) Unified CCXT market symbol (e.g. `"BTC/USDT:USDT"`) _required_ on most exchanges. Is not required when leverage is not specific to a market (e.g. If leverage is set for the account and not per market)
...
-   an array of [leverage-structures](https://docs.ccxt.com/#/?id=leverage-structure)

### [Leverage Structure](https://docs.ccxt.com/#/?id=leverage-structure)
...
## [Contract Trading](https://docs.ccxt.com/#/?id=contract-trading)
...
-   An array of [position structures](https://docs.ccxt.com/#/?id=position-structure)
...
-   **limit** (Integer) The number of [position structures](https://docs.ccxt.com/#/?id=position-structure) to retrieve (e.g. `5`)
-   **params** (Dictionary) Parameters specific to the exchange API endpoint (e.g. `{"endTime": 1645807945000}`)
...
#### [Position Structure](https://docs.ccxt.com/#/?id=position-structure)
...
#### [Closing Positions](https://docs.ccxt.com/#/?id=closing-positions)
...
-   **symbol** (String) _required_ Unified CCXT market symbol (e.g. `"BTC/USDT:USDT"`)
-   **side** _optional_ a string literal for the direction of your order. Some exchanges require it. **Unified sides:**
    -   `buy` give quote currency and receive base currency; for example, buying `BTC/USD` means that you will receive bitcoins for your dollars.
    -   `sell` give base currency and receive quote currency; for example, buying `BTC/USD` means that you will receive dollars for your bitcoins.
-   **params** (Dictionary) Parameters specific to the exchange API endpoint (e.g. `{"endTime": 1645807945000}`)
...
### [Position Mode](https://docs.ccxt.com/#/?id=position-mode)
...
-   **hedged** (String) _required_ hedged-mode value:
...
#### [Liquidation Price](https://docs.ccxt.com/#/?id=liquidation-price)
...
-   **limit** (Integer) The number of [funding history structures](https://docs.ccxt.com/#/?id=funding-history-structure) to retrieve (e.g. `5`)
-   **params** (Dictionary) Parameters specific to the exchange API endpoint (e.g. `{"endTime": 1645807945000}`)

Returns

-   An array of [funding history structures](https://docs.ccxt.com/#/?id=funding-history-structure)

#### [Funding History Structure](https://docs.ccxt.com/#/?id=funding-history-structure)
...
-   **fromCode** (String) _required_ The unified currency code for the currency to convert from (e.g. `"USDT"`)
-   **toCode** (String) _required_ The unified currency code for the currency to be converted into (e.g. `"USDC"`)
...
-   **id** (String) _required_ Conversion quote id (e.g. `1645807945000`)
-   **fromCode** (String) _required_ The unified currency code for the currency to convert from (e.g. `"USDT"`)
-   **toCode** (String) _required_ The unified currency code for the currency to be converted into (e.g. `"USDC"`)
-   **amount** (Float) Amount to convert in units of the from currency (e.g. `20.0`)
-   **params** (Dictionary) Parameters specific to the exchange API endpoint (e.g. `{"toAmount": 2.9722}`)
...
-   **id** (String) _required_ Conversion trade id (e.g. `"80794187SDHJ25"`)
...
-   An array of [conversion structures](https://docs.ccxt.com/#/?id=conversion-structure)

#### [Conversion Structure](https://docs.ccxt.com/#/?id=conversion-structure)
...
## [Proxy](https://docs.ccxt.com/#/?id=proxy)
...
### [Supported proxy types](https://docs.ccxt.com/#/?id=supported-proxy-types)

CCXT supports the following proxy types (note, each of them also have [callback support](https://docs.ccxt.com/#/?id=using-proxy-callbacks)):

#### [proxyUrl](https://docs.ccxt.com/#/?id=proxyurl)

This property prepends an url to API requests. It might be useful for simple redirection or [bypassing CORS browser restriction](https://docs.ccxt.com/#/?id=cors-access-control-allow-origin).
...
#### [httpProxy and httpsProxy](https://docs.ccxt.com/#/?id=httpproxy-and-httpsproxy)
...
So, both connections (HTTP & WS) would go through proxies. ((_How to test if your proxy works_))\[#test-if-your-proxy-works\]

#### [socksProxy](https://docs.ccxt.com/#/?id=socksproxy)
...
#### [Test if your proxy works](https://docs.ccxt.com/#/?id=test-if-your-proxy-works)
...
#### [using proxy callbacks](https://docs.ccxt.com/#/?id=using-proxy-callbacks)
...
#### [userAgent](https://docs.ccxt.com/#/?id=useragent)
...
#### [custom proxy agents](https://docs.ccxt.com/#/?id=custom-proxy-agents)
...
#### [CORS (Access-Control-Allow-Origin)](https://docs.ccxt.com/#/?id=cors-access-control-allow-origin)

CORS (known as [Cross-Origin Resource Sharing](https://en.wikipedia.org/wiki/Cross-origin_resource_sharing)) affects mostly browsers and is the cause of the well-know warning `No 'Access-Control-Allow-Origin' header is present on the requested resource`. It happens when a script (running in a browser) makes a request to a 3rd party domain (by default such requests are blocked, unless the target domain explicitly allows it). So, in such cases you will need to communicate with a "CORS" proxy, which would redirect requests (as opposed to direct browser-side request) to the target exchange. To set a CORS proxy, you can run [sample-local-proxy-server-with-cors](https://github.com/ccxt/ccxt/blob/master/examples/) example file and in ccxt set the [`.proxyUrl`](https://docs.ccxt.com/#/?id=proxyurl) property to route requests through cors/proxy server.

## [String Math](https://docs.ccxt.com/#/?id=string-math)
...
-   [Retry Mechanism](https://docs.ccxt.com/#/?id=retry-mechanism)
-   [Exception Hierarchy](https://docs.ccxt.com/#/?id=exception-hierarchy)
-   [ExchangeError](https://docs.ccxt.com/#/?id=exchangeerror)
-   [OperationFailed](https://docs.ccxt.com/#/?id=operationfailed)
-   [DDoSProtection](https://docs.ccxt.com/#/?id=ddosprotection)
-   [RateLimitExceeded](https://docs.ccxt.com/#/?id=ratelimitexceeded)
-   [RequestTimeout](https://docs.ccxt.com/#/?id=requesttimeout)
-   [RequestTimeout](https://docs.ccxt.com/#/?id=requesttimeout)
-   [ExchangeNotAvailable](https://docs.ccxt.com/#/?id=exchangenotavailable)
-   [InvalidNonce](https://docs.ccxt.com/#/?id=invalidnonce)
...
Raised when your nonce is less than the previous nonce used with your keypair, as described in the [Authentication](https://docs.ccxt.com/#/?id=authentication) section. This type of exception is thrown in these cases (in order of precedence for checking):
...
### [Handling timestamp errors](https://docs.ccxt.com/#/?id=handling-timestamp-errors)

Users may occasionally encounter errors such as:

> "Timestamp for this request is outside of the recvWindow." "Invalid request, please check your server timestamp or recv\_window param." "Timestamp for this request was 1000ms ahead of the server's time."

These issues can arise for several reasons:

#### [1\. System Clock Desynchronization](https://docs.ccxt.com/#/?id=_1-system-clock-desynchronization)
...
#### [2\. Network Latency or Delayed Requests](https://docs.ccxt.com/#/?id=_2-network-latency-or-delayed-requests)
...
#### [Adjusting Exchange Options](https://docs.ccxt.com/#/?id=adjusting-exchange-options)
...
A) `exchange.options['adjustForTimeDifference'] = True` or increase window to eg. 10 seconds (only if an exchange supports it, search this keyword in target [exchange file](https://github.com/ccxt/ccxt/tree/master/ts/src)): B) `exchange.options['recvWindow'] = 10000`
...
-   Make sure that you have the most recent version of ccxt. Never trust your package installer (whether it is `npm`, `pip` or `composer`), instead always check your **actual (real) runtime version number** by running this code in your environment:
...
-   Check the [Issues](https://github.com/ccxt/ccxt/issues) or [Announcements](https://docs.ccxt.com/#/?id=announcements) for recent updates.
-   Make sure you have not turned off [rate-limiter with `enableRateLimit: false`](https://docs.ccxt.com/#/?id=rate-limit) (If anyone has custom rate-limit solution built, ensure it does not misbehave).
...
-   Read the answers to Frequently Asked Questions: [https://github.com/ccxt/ccxt/wiki/FAQ](https://github.com/ccxt/ccxt/wiki/FAQ)
-   Check the permissions on the keypair with the exchange website!
-   Check your nonce. If you used your API keys with other software, you most likely should [override your nonce function](https://docs.ccxt.com/#/?id=overriding-the-nonce) to match your previous nonce value. A nonce usually can be easily reset by generating a new unused keypair. If you are getting nonce errors with an existing key, try with a new API key that hasn't been used yet.
-   Check your request rate if you are getting nonce errors. Your private requests should not follow one another quickly. You should not send them one after another in a split second or in short time. The exchange will most likely ban you if you don't make a delay before sending each new request. In other words, you should not hit their rate limit by sending unlimited private requests too frequently. Add a delay to your subsequent requests or enable the built-in rate-limiter, like shown in the long-poller [examples](https://github.com/ccxt/ccxt/tree/master/examples), also [here](https://docs.ccxt.com/#/?id=order-book--market-depth).
...
-   Check your connection with the exchange through a [proxy](https://docs.ccxt.com/#/?id=proxy).
...
-   Some exchanges are not available in certain countries, using a [proxy](https://docs.ccxt.com/#/?id=proxy) might be the solution in such cases.
-   If you are getting authentication errors or _'invalid keys'_ errors, those are most likely due to a nonce issue.
