...
Usage:
    python -m services.telegram-service.src bot   # Start Telegram Bot
    python -m services.telegram-service.src api   # Start FastAPI server
    python -m services.telegram-service.src both  # Start both
"""
import sys
