...
| 品种 | 交易数 | 加权胜率 | 平均 PF |
| --- | --- | --- | --- |
| `BTCUSDT` | `1594` | `23.59%` | `0.571` |
| `ETHUSDT` | `1168` | `26.20%` | `0.572` |
| `BNBUSDT` | `273` | `29.67%` | `0.561` |
| `SOLUSDT` | `250` | `35.20%` | `0.727` |
...
| 家族 | 交易数 | 胜率 | PF | 平均 R |
| --- | --- | --- | --- | --- |
| `趋势恢复族` | `2242` | `23.95%` | `0.582` | `-0.123` |
| `MTR反转族` | `707` | `31.68%` | `0.662` | `-0.006` |
| `高潮/陷阱反转族` | `206` | `27.67%` | `0.493` | `-0.164` |
| `突破追随族` | `99` | `24.24%` | `0.679` | `-0.249` |
...
| 动作 | 交易数 | PF | 平均 R |
| --- | --- | --- | --- |
| `partial_close_involved` | `1430 -> 1656` | `0.946 -> 0.586` | `0.192 -> -0.057` |
| `trailing_stop_exit` | `1205 -> 1661` | `0.328 -> 0.472` | `-0.103 -> -0.115` |
| `breakeven_stop_exit` | `858 -> 1077` | `1.073 -> 1.897` | `-0.040 -> -0.026` |
| `take_profit_exit` | `1174 -> 1067` | `16.721 -> 12.963` | `0.294 -> 0.075` |
| `premise_failure_exit` | `764 -> 401` | `0.048 -> 0.104` | `-0.295 -> -0.131` |
| `plain_stop_loss_exit` | `154 -> 151` | `0.000 -> 0.000` | `-1.255 -> -1.255` |
| `protective_scalp_involved` | `1867 -> 1982` | `0.528 -> 0.256` | `-0.090 -> -0.170` |
| `reentry_trade` | `71 -> 80` | `0.556 -> 1.026` | `-0.197 -> -0.151` |
| `scale_in_trade` | `92 -> 145` | `52.957 -> 33.462` | `3.694 -> 0.765` |
...
1. premise 早退已经大幅压下来了
2. 但很多交易从 `PREMISE` 转移成了“被保护性止损打掉”
3. `plain stop loss` 没明显恶化，真正上升的是“带移动痕迹的 SL / trailing / protective”类别
4. `re-entry` 已经开始出现真实正反馈

换句话说：

- 这轮之后，系统的主问题已经从“过早认错”转成了“保护性退出后，余仓和尾仓怎么处理得更好”

### 7.7 逐窗口结果

| 窗口 | 交易数 | 胜率 | PF |
| --- | --- | --- | --- |
| `BTC 5m 2022` | `646 -> 643` | `24.30% -> 25.82%` | `0.507 -> 0.572` |
| `BTC 15m 2022` | `254 -> 247` | `28.74% -> 30.36%` | `0.670 -> 0.775` |
| `ETH 5m 2022` | `650 -> 646` | `26.46% -> 27.86%` | `0.535 -> 0.611` |
| `ETH 15m 2023` | `293 -> 287` | `16.72% -> 20.56%` | `0.249 -> 0.399` |
| `BTC 1h 2022` | `52 -> 50` | `21.15% -> 28.00%` | `0.366 -> 0.576` |
| `BTC 5m 2025` | `650 -> 654` | `17.23% -> 18.50%` | `0.327 -> 0.363` |
| `ETH 15m 2023Q1` | `230 -> 235` | `27.39% -> 28.51%` | `0.572 -> 0.707` |
| `BNB 15m 2022Q1` | `277 -> 273` | `25.27% -> 29.67%` | `0.435 -> 0.561` |
| `SOL 15m 2025Q2` | `250 -> 250` | `30.80% -> 35.20%` | `0.527 -> 0.727` |
