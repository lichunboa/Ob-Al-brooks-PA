...
## 12. 第五阶段结果：把 Endless Pullback 从趋势恢复主链里剥出去
...
这一阶段的核心不再是继续抠 exit，而是把 Brooks 原文里明显更像 `endless pullback / weak follow-through / channel -> TR` 的情形，从 `高1/低1/高2/低2/突破回调/均线缺口` 的可执行主链里剥出去。
...
这说明这一步已经不是“只涨几个点”的微调，而是明确把一类低质量趋势恢复单切掉了。
...
1. **逻辑本身已经接近可赚钱**
2. **但边际优势还不够厚，真实交易成本会把它压回 `1` 以下**

### 12.3 根因更新

因此当前总根因应更新为：

1. 之前最大的信号偏差，确实是把太多 Endless PB 当成趋势恢复
2. `protective_stop_exit` 仍然是最大的亏损桶
3. `runner trailing / TP1/TP2 / protective scalp` 已经不是主问题
4. 当前剩余差距，已经开始表现为“真实成本覆盖不足”
