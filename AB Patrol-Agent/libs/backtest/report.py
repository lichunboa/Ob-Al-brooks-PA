    ...
    def from_exchange(cls, exchange, symbol: str, threshold: int = 80,
        ...
        return cls(
            ...
            trades=[{
                ...
                "initial_stop_loss": round(t.initial_stop_loss, 6),
                ...
                "signal_bar_body_ratio": round(t.signal_bar_body_ratio, 4),
                "signal_bar_good_tail_ratio": round(t.signal_bar_good_tail_ratio, 4),
                "signal_bar_inside": t.signal_bar_inside,
                "signal_bar_ema_recovery": t.signal_bar_ema_recovery,
                "signal_bar_type": t.signal_bar_type,
                "setup_valid": t.setup_valid,
                "setup_clear_trend_leg": t.setup_clear_trend_leg,
                "setup_first_pullback_shape": t.setup_first_pullback_shape,
                "setup_still_trend_side": t.setup_still_trend_side,
                "setup_prior_leg_bars": t.setup_prior_leg_bars,
                "setup_pullback_bars": t.setup_pullback_bars,
                "setup_pullback_depth_ratio": round(t.setup_pullback_depth_ratio, 4),
                "setup_pullback_overlap_ratio": round(t.setup_pullback_overlap_ratio, 4),
                "nominal_risk": round(t.nominal_risk, 6),
                "actual_risk": round(t.actual_risk, 6),
                "stop_type": t.stop_type,
                "signal_bar_stop": round(t.signal_bar_stop, 6),
                "swing_stop": round(t.swing_stop, 6),
                "major_hl_lh_stop": round(t.major_hl_lh_stop, 6),
                "major_anchor": round(t.major_anchor, 6),
                ...
                "first_target": round(t.first_target, 6),
                "first_target_type": t.first_target_type,
                "rescue_target": round(t.rescue_target, 6),
                "rescue_target_type": t.rescue_target_type,
                "close_test_target": round(t.close_test_target, 6),
                "close_test_target_type": t.close_test_target_type,
                "swing_target": round(t.swing_target, 6),
                ...
                "effective_target": round(t.effective_target, 6),
                "effective_target_type": t.effective_target_type,
                ...
                "weak_h1_l1_disposition": t.weak_h1_l1_disposition,
                "executed_as_fade": t.executed_as_fade,
                "fade_source_signal": t.fade_source_signal,
                "management_style": t.management_style, "route_style": t.route_style,
                "reentry_attempt": t.reentry_attempt,
                "scale_legs": t.scale_legs,
                "risk_percent": round(t.risk_percent, 4),
                "initial_risk": round(t.initial_risk, 6),
                "r_multiple": round(t.r_multiple, 4),
                "tp1_done": t.tp1_done,
                "tp2_done": t.tp2_done,
                "partial_close_count": t.partial_close_count,
                "stop_adjust_count": t.stop_adjust_count,
                "take_profit_adjust_count": t.take_profit_adjust_count,
                ...
                "protective_runner_kept": t.protective_runner_kept,
                "trailing_exit_type": t.trailing_exit_type,
                "profit_exit_type": t.profit_exit_type,
                "market_cost_profile": t.market_cost_profile,
                "management_template": t.management_template,
                "first_entry_signal": t.first_entry_signal,
                "first_profit_at_1x_actual_risk": t.first_profit_at_1x_actual_risk,
                "allow_be_after_first_target": t.allow_be_after_first_target,
                "prefer_partial_over_full_swing": t.prefer_partial_over_full_swing,
                "allow_small_runner": t.allow_small_runner,
                "handoff_to_h2_l2_if_failed": t.handoff_to_h2_l2_if_failed,
                "prefer_lower_entry_be_rescue": t.prefer_lower_entry_be_rescue,
                "first_target_is_close_test": t.first_target_is_close_test,
                "disappointed_bull_bear_mode": t.disappointed_bull_bear_mode,
                "exit_on_failed_follow_through": t.exit_on_failed_follow_through,
                "exit_on_return_to_range": t.exit_on_return_to_range,
                "exit_on_major_channel_break": t.exit_on_major_channel_break,
                "runner_handoff_stop": round(t.runner_handoff_stop, 6),
                "runner_handoff_stop_type": t.runner_handoff_stop_type,
                "entry_cost_pct": round(t.entry_cost_pct, 4),
                "exit_cost_pct": round(t.exit_cost_pct, 4),
                ...
                "best_price": round(t.best_price, 6),
                "best_price_bar": t.best_price_bar,
                "worst_price": round(t.worst_price, 6),
