...
class Trade:
    ...
    signal_bar_good_tail_ratio: float = 0.0
    signal_bar_inside: bool = False
    signal_bar_ema_recovery: bool = False
    ...
    setup_clear_trend_leg: bool = False
    setup_first_pullback_shape: bool = False
    setup_still_trend_side: bool = False
    setup_prior_leg_bars: int = 0
    setup_pullback_bars: int = 0
    ...
    nominal_risk: float = 0.0
    actual_risk: float = 0.0
    stop_type: str = ""
    signal_bar_stop: float = 0.0
    swing_stop: float = 0.0
    major_hl_lh_stop: float = 0.0
    major_anchor: float = 0.0
    first_target_distance_r: float = 0.0
    first_target: float = 0.0
    first_target_type: str = ""
    rescue_target: float = 0.0
    rescue_target_type: str = ""
    close_test_target: float = 0.0
    close_test_target_type: str = ""
    swing_target: float = 0.0
    ...
    stretch_target: float = 0.0
    stretch_target_type: str = ""
    ...
    first_entry_signal: bool = False
    first_profit_at_1x_actual_risk: bool = False
    allow_be_after_first_target: bool = False
    prefer_partial_over_full_swing: bool = False
    allow_small_runner: bool = False
    handoff_to_h2_l2_if_failed: bool = False
    prefer_lower_entry_be_rescue: bool = False
    first_target_is_close_test: bool = False
    disappointed_bull_bear_mode: bool = False
    exit_on_failed_follow_through: bool = False
    exit_on_return_to_range: bool = False
    exit_on_major_channel_break: bool = False
    runner_handoff_stop: float = 0.0
