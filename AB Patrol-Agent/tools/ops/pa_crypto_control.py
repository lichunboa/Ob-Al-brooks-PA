...
from runtime.env_loader import load_agent_env  # noqa: E402
from runtime.path_layout import data_run_dir  # noqa: E402
from runtime.status_common import render_recent_text, render_status_card, runtime_snapshot  # noqa: E402
...
def _funnel_text() -> str:
    ...
    snapshot = runtime_snapshot(
        ...
        execution_bot_id=_execution_bot_id(),
        include_funnel=True,
    )
...
def main() -> int:
    ...
    parser.add_argument(
        "command",
        choices=["status", "card", "recent", "decision", "funnel", "full", "paths", "start", "stop", "restart"],
    )
