...
def check_execution_state():
    """检查 execution 状态文件"""
    state_file = Path(__file__).parent.parent / "data" / "pa_trader" / "state" / "runtime_state.json"
...
def check_decision_log():
    """检查决策日志"""
    log_file = Path(__file__).parent.parent / "data" / "pa_trader" / "journal" / "decision_log.jsonl"
...
def check_execution_log():
    """检查执行日志"""
    log_file = Path(__file__).parent.parent / "data" / "pa_trader" / "journal" / "execution_log.jsonl"
